...
{      
    ...
    glh::set_viewport(gl, 0, 0, app.settings.window_size.0 * 2, app.settings.window_size.1 * 2);
    ...
    for p in &mut _data.particles{
        ...
        shader.set_uniform_4f( gl, glh::StockShader::uniform_name_color(), &glm::vec4(red, green, blue, 1.0));
    ...
    _data.particles.push(Particle{
        ...
        position: glm::vec3(xpos as f32 * frame_buffer_scale, ypos as f32 * frame_buffer_scale, 0.0),
